			          		...
			          		<div class="col-md-6">
			                	<div class="product-tab">
				      	   	...
				      	   	<div class="col-md-6">
					                ...
					                <br> <b>&nbsp&nbsp&nbsp&nbspPrice: ₹'.$row['product_price'].'/unit</b><br><br></p> 
					                <a href="details_form.php?product_id='.$product_id.'" class="btn btn-lg btn-danger">Apply for Loan</a>
